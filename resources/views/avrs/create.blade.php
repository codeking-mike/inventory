...
@section('title', 'Add AVR')

@section('content')
<div class="max-w-2xl mx-auto">
    <h1 class="text-3xl font-bold mb-8 text-gray-800">Add New AVR</h1>

    <div class="bg-white rounded-lg shadow p-8">
        <form action="{{ route('avrs.store') }}" method="POST">
            @csrf
            
            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Product Name*</label>
                <input type="text" name="product_name" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('product_name') }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="text" name="model" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('model') }}">
                @error('model') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
            </div>

            <div class="mb-4">
                <label class="block text-gray-700 font-semibold mb-2">Capacity (KVA)*</label>
                <input type="number" name="capacity" step="0.01" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('capacity') }}" required>
            ...
            <div class="mb-4">
                ...
                <input type="number" name="quantity_in_stock" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('quantity_in_stock', 0) }}" required>
            ...
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input type="number" name="cost_price" step="0.01" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('cost_price') }}">
                ...
                <div>
                    ...
                    <input type="number" name="selling_price" step="0.01" class="w-full border border-gray-300 rounded px-3 py-2" value="{{ old('selling_price') }}">
            ...
            <div class="flex space-x-4">
                <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-6 py-2 rounded">Save AVR</button>
